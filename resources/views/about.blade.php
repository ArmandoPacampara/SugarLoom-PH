...
<nav class="sticky top-0 z-50 flex h-[70px] items-center justify-between bg-[#e06b87] px-8 md:px-16">
    ...
    <div class="absolute left-1/2 hidden -translate-x-1/2 gap-10 md:flex">
        ...
        <a href="{{ route('dashboard') }}" class="text-sm font-normal text-white no-underline transition hover:opacity-80">Dashboard</a>
    </div>
    <div class="flex gap-3">
        ...
        <span class="grid h-[38px] w-[38px] place-items-center rounded-full border border-white/50 text-[#1a1018] transition hover:bg-white/20" aria-label="Account">
