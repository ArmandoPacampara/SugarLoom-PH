...
@section('title', 'Edit User | SugarLoom PH')
        ...
        <form method="POST" action="{{ route('admin.users.update', $user) }}">
            ...
            <div class="grid">
                ...
                <div>
                    ...
                    <input id="reward_points" type="number" min="0" name="reward_points" value="{{ old('reward_points', (int) $user->reward_points) }}">
                </div>
                <div class="full">
                    <label for="shipping_address">Shipping Address</label>
                    <input id="shipping_address" name="shipping_address" value="{{ old('shipping_address', $user->shipping_address) }}">
                </div>
                <div>
                ...
                <div>
                    ...
                    <input id="postal_code" name="postal_code" value="{{ old('postal_code', $user->postal_code) }}">
                </div>
                <div class="full">
